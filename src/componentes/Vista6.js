...
import miImagen from '../imagenes/producto5.jpeg';

const Vista6 = () => {
  const [carrito, setCarrito] = useState([]);
  const precioProducto = 149; // Guarda el precio como número para facilitar cálculos
  ...
  return (
    <div style={{ textAlign: 'left', marginTop: '16px' }}>
      ...
      <p style={{ fontSize: '16px', color: 'black' }}>"El rímel para pestañas es un producto de maquillaje diseñado para realzar y definir las pestañas. Su fórmula suele agregar volumen, longitud y color a las pestañas, resaltando la expresividad de los ojos. Aplicado con el cepillo especial, el rímel proporciona un aspecto más definido y atractivo a las pestañas, realzando la belleza de los ojos."</p>
